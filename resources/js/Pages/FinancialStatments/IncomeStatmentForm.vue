...
import IncomeStatment from '@/pages/FinancialStatments/IncomeStatment.vue';
...
function submit(){
  // winbox.close()
    ...
    .post(route('IncomeStatment'),{
      onSuccess: () =>{
         // winbox.close()
         FormResult.value=page.props.Income_Statment[winbox.id]
...
<div  class="hidden" >
  <div   class=" m-4" ref="inventory_Valuation" >
        ...
        <h4  class="my-5 text-2xl" >Income Statment</h4>
