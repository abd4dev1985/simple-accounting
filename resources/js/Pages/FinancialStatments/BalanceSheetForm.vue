...
import BalanceSheet from '@/pages/FinancialStatments/BalanceSheet.vue';
...
function submit(){
  // winbox.close()
    ...
    .post(route('BalanceSheet'),{
      onSuccess: () =>{
         // winbox.close()
         FormResult.value=page.props.Balance_Sheet[winbox.id]
...
<div  class="hidden" >
  <div   class=" m-4" ref="inventory_Valuation" >
        ...
        <h4  class="my-5 text-2xl" >Balance Sheet</h4>
        ...
        <div v-if="FormResult" class="" >
            ...
            <BalanceSheet :accounts="FormResult" >
